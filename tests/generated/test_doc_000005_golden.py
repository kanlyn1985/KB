...
def test_doc_000005_golden_209() -> None:
    case = '{"kind": "page_coverage", "query": "AutomotiveSPICE_PAM_40_Chinese：第235页 PA 2.2 Work product management process", "must_include": "PA 2.2 Work product management process", "source": "local", "assert_mode": "context_contains", "page_no": 235, "target_doc_id": "DOC-000005"}'
    _assert_case(json.loads(case))
...
def test_doc_000005_golden_210() -> None:
    case = '{"kind": "page_coverage", "query": "AutomotiveSPICE_PAM_40_Chinese：第237页 *Note 3: Possible sources for the iden", "must_include": "*Note 3: Possible sources for the iden", "source": "local", "assert_mode": "context_contains", "page_no": 237, "target_doc_id": "DOC-000005"}'
    _assert_case(json.loads(case))
...
def test_doc_000005_golden_211() -> None:
    case = '{"kind": "page_coverage", "query": "AutomotiveSPICE_PAM_40_Chinese：第238页 *注 3：存储和控制要求识别的来源可以是法律要求、数据政策、其他项目的最佳实", "must_include": "*注 3：存储和控制要求识别的来源可以是法律要求、数据政策、其他项目的最佳实", "source": "local", "assert_mode": "context_contains", "page_no": 238, "target_doc_id": "DOC-000005"}'
    _assert_case(json.loads(case))
...
def test_doc_000005_golden_212() -> None:
    case = '{"kind": "page_coverage", "query": "AutomotiveSPICE_PAM_40_Chinese：第240页 过程能力等级 3 级：已建立的过程 以下过程属性结合先前已定义的过程属性，证", "must_include": "过程能力等级 3 级：已建立的过程 以下过程属性结合先前已定义的过程属性，证", "source": "local", "assert_mode": "context_contains", "page_no": 240, "target_doc_id": "DOC-000005"}'
    _assert_case(json.loads(case))
...
def test_doc_000005_golden_213() -> None:
    case = '{"kind": "page_coverage", "query": "AutomotiveSPICE_PAM_40_Chinese：第241页 ## Generic practices #### GP 3.1.1 Est", "must_include": "## Generic practices #### GP 3.1.1 Est", "source": "local", "assert_mode": "context_contains", "page_no": 241, "target_doc_id": "DOC-000005"}'
    _assert_case(json.loads(case))
...
def test_doc_000005_golden_214() -> None:
    case = '{"kind": "page_coverage", "query": "AutomotiveSPICE_PAM_40_Chinese：第242页 定义了标准过程的输入和输出，包括相应的准入和准出准则，以确定与其它过程的交互", "must_include": "定义了标准过程的输入和输出，包括相应的准入和准出准则，以确定与其它过程的交互", "source": "local", "assert_mode": "context_contains", "page_no": 242, "target_doc_id": "DOC-000005"}'
    _assert_case(json.loads(case))
...
def test_doc_000005_golden_215() -> None:
    case = '{"kind": "page_coverage", "query": "AutomotiveSPICE_PAM_40_Chinese：第243页 Note 7: Methods and activities to gath", "must_include": "Note 7: Methods and activities to gath", "source": "local", "assert_mode": "context_contains", "page_no": 243, "target_doc_id": "DOC-000005"}'
    _assert_case(json.loads(case))
...
def test_doc_000005_golden_216() -> None:
    case = '{"kind": "page_coverage", "query": "AutomotiveSPICE_PAM_40_Chinese：第244页 定义了监控标准过程所需的适当准则和信息。", "must_include": "定义了监控标准过程所需的适当准则和信息。", "source": "local", "assert_mode": "context_contains", "page_no": 244, "target_doc_id": "DOC-000005"}'
    _assert_case(json.loads(case))
...
def test_doc_000005_golden_217() -> None:
    case = '{"kind": "page_coverage", "query": "AutomotiveSPICE_PAM_40_Chinese：第245页 Note 1: Changes in the standard proces", "must_include": "Note 1: Changes in the standard proces", "source": "local", "assert_mode": "context_contains", "page_no": 245, "target_doc_id": "DOC-000005"}'
    _assert_case(json.loads(case))
...
def test_doc_000005_golden_218() -> None:
    case = '{"kind": "page_coverage", "query": "AutomotiveSPICE_PAM_40_Chinese：第246页 过程属性成就 1）基于适当的已选择的 和/或 裁剪的标准过程部署了已定义过程", "must_include": "过程属性成就 1）基于适当的已选择的 和/或 裁剪的标准过程部署了已定义过程", "source": "local", "assert_mode": "context_contains", "page_no": 246, "target_doc_id": "DOC-000005"}'
    _assert_case(json.loads(case))
...
def test_doc_000005_golden_219() -> None:
    case = '{"kind": "page_coverage", "query": "AutomotiveSPICE_PAM_40_Chinese：第247页 Results of the analysis are made avail", "must_include": "Results of the analysis are made avail", "source": "local", "assert_mode": "context_contains", "page_no": 247, "target_doc_id": "DOC-000005"}'
    _assert_case(json.loads(case))
...
def test_doc_000005_golden_220() -> None:
    case = '{"kind": "page_coverage", "query": "AutomotiveSPICE_PAM_40_Chinese：第248页 根据确定的过程监控方法收集和分析信息，以理解已定义过程的有效性和充分性。提供", "must_include": "根据确定的过程监控方法收集和分析信息，以理解已定义过程的有效性和充分性。提供", "source": "local", "assert_mode": "context_contains", "page_no": 248, "target_doc_id": "DOC-000005"}'
    _assert_case(json.loads(case))

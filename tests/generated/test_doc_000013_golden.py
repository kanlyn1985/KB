...
def test_doc_000013_golden_17() -> None:
    case = '{"kind": "evidence", "query": "V2G相关：27ᵗʰ, 2024 ### Abstract Vehicle-to-Grid (V", "must_include": "27ᵗʰ, 2024 ### Abstract Vehicle-to-Grid (V", "source": "local", "assert_mode": "context_contains", "page_no": 1, "target_doc_id": "DOC-000013"}'
    _assert_case(json.loads(case))

@pytest.mark.integration
@pytest.mark.benchmark
def test_doc_000013_golden_18() -> None:
    case = '{"kind": "evidence", "query": "V2G相关：Not only does it optimize the use of elect", "must_include": "Not only does it optimize the use of elect", "source": "local", "assert_mode": "context_contains", "page_no": 1, "target_doc_id": "DOC-000013"}'
    _assert_case(json.loads(case))

@pytest.mark.integration
@pytest.mark.benchmark
def test_doc_000013_golden_19() -> None:
    case = '{"kind": "evidence", "query": "V2G相关：山博轩，杨郁 comprehensive energy systems, and r", "must_include": "山博轩，杨郁 comprehensive energy systems, and r", "source": "local", "assert_mode": "context_contains", "page_no": 2, "target_doc_id": "DOC-000013"}'
    _assert_case(json.loads(case))

@pytest.mark.integration
@pytest.mark.benchmark
def test_doc_000013_golden_20() -> None:
    case = '{"kind": "evidence", "query": "V2G相关：The limitations and problems in the pilot", "must_include": "The limitations and problems in the pilot", "source": "local", "assert_mode": "context_contains", "page_no": 2, "target_doc_id": "DOC-000013"}'
    _assert_case(json.loads(case))

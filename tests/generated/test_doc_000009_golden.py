...
def test_doc_000009_golden_36() -> None:
    case = '{"kind": "coverage_requirement", "query": "ISO 2013有哪些要求？", "must_include": "ISO 2013", "source": "coverage", "assert_mode": "rich_answer", "target_doc_id": "DOC-000009", "expected_evidence_shape": "requirement", "page_no": 6, "coverage_unit_id": "DOC-000009:requirement:6:1670A5E703A6", "coverage_semantic_key": "ISO 2013"}'
    _assert_case(json.loads(case))
...
def test_doc_000009_golden_37() -> None:
    case = '{"kind": "coverage_requirement", "query": "UDSonK-Line services overview有哪些要求？", "must_include": "UDSonK-Line services overview", "source": "coverage", "assert_mode": "rich_answer", "target_doc_id": "DOC-000009", "expected_evidence_shape": "requirement", "page_no": 10, "coverage_unit_id": "DOC-000009:requirement:10:DC6589E4E1CF", "coverage_semantic_key": "UDSonK-Line services overview"}'
    _assert_case(json.loads(case))
...
def test_doc_000009_golden_38() -> None:
    case = '{"kind": "coverage_requirement", "query": "AccessTimingParameter (0x83) service有哪些要求？", "must_include": "AccessTimingParameter (0x83) service", "source": "coverage", "assert_mode": "rich_answer", "target_doc_id": "DOC-000009", "expected_evidence_shape": "requirement", "page_no": 11, "coverage_unit_id": "DOC-000009_requirement_11_8", "coverage_semantic_key": "AccessTimingParameter (0x83) service"}'
    _assert_case(json.loads(case))
...
def test_doc_000009_golden_39() -> None:
    case = '{"kind": "coverage_requirement", "query": "LinkControl (0x87) service有哪些要求？", "must_include": "LinkControl (0x87) service", "source": "coverage", "assert_mode": "rich_answer", "target_doc_id": "DOC-000009", "expected_evidence_shape": "requirement", "page_no": 11, "coverage_unit_id": "DOC-000009:requirement:11:87160E669051", "coverage_semantic_key": "LinkControl (0x87) service"}'
    _assert_case(json.loads(case))
...
def test_doc_000009_golden_40() -> None:
    case = '{"kind": "coverage_requirement", "query": "Application layer timing parameter values有哪些要求？", "must_include": "Application layer timing parameter values", "source": "coverage", "assert_mode": "rich_answer", "target_doc_id": "DOC-000009", "expected_evidence_shape": "requirement", "page_no": 12, "coverage_unit_id": "DOC-000009_requirement_12_17", "coverage_semantic_key": "Application layer timing parameter values"}'
    _assert_case(json.loads(case))
...
def test_doc_000009_golden_41() -> None:
    case = '{"kind": "coverage_requirement", "query": "Mapping of data link independent service primitives onto K-Line data link dependent service primitives有哪些要求？", "must_include": "Mapping of data link independent service primitives onto K-Line data link dependent service primitives", "source": "coverage", "assert_mode": "rich_answer", "target_doc_id": "DOC-000009", "expected_evidence_shape": "requirement", "page_no": 13, "coverage_unit_id": "DOC-000009:requirement:13:4F9759AA1C9B", "coverage_semantic_key": "Mapping of data link independent service primitives onto K-Line data link dependent service primitives"}'
    _assert_case(json.loads(case))
...
def test_doc_000009_golden_42() -> None:
    case = '{"kind": "coverage_requirement", "query": "Mapping of data link independent service primitives onto K-Line data link dependent service primitives Table 4 specifies the mapping interface between the ISO 14230-2 DoK-Line Part 2: Data link layer services and the ISO 14229-2 UDS Part 2有哪些要求？", "must_include": "Mapping of data link independent service primitives onto K-Line data link dependent service primitives Table 4 specifies the mapping interface between the ISO 14230-2 DoK-Line Part 2: Data link layer services and the ISO 14229-2 UDS Part 2", "source": "coverage", "assert_mode": "rich_answer", "target_doc_id": "DOC-000009", "expected_evidence_shape": "requirement", "page_no": 13, "coverage_unit_id": "DOC-000009:requirement:13:1F9DA97C2F0D", "coverage_semantic_key": "Mapping of data link independent service primitives onto K-Line data link dependent service primitives Table 4 specifies the mapping interface between the ISO 14230-2 DoK-Line Part 2: Data link layer services and the ISO 14229-2 UDS Part 2"}'
    _assert_case(json.loads(case))
...
def test_doc_000009_golden_43() -> None:
    case = '{"kind": "coverage_requirement", "query": "Mapping of T_PDU onto DL_PDU for message transmission有哪些要求？", "must_include": "Mapping of T_PDU onto DL_PDU for message transmission", "source": "coverage", "assert_mode": "rich_answer", "target_doc_id": "DOC-000009", "expected_evidence_shape": "requirement", "page_no": 14, "coverage_unit_id": "DOC-000009:requirement:14:0A3CF9350368", "coverage_semantic_key": "Mapping of T_PDU onto DL_PDU for message transmission"}'
    _assert_case(json.loads(case))
...
def test_doc_000009_golden_44() -> None:
    case = '{"kind": "coverage_requirement", "query": "Session handling有哪些要求？", "must_include": "Session handling", "source": "coverage", "assert_mode": "rich_answer", "target_doc_id": "DOC-000009", "expected_evidence_shape": "requirement", "page_no": 14, "coverage_unit_id": "DOC-000009_requirement_14_15", "coverage_semantic_key": "Session handling"}'
    _assert_case(json.loads(case))
...
def test_doc_000009_golden_45() -> None:
    case = '{"kind": "coverage_requirement", "query": "Error handling有哪些要求？", "must_include": "Error handling", "source": "coverage", "assert_mode": "rich_answer", "target_doc_id": "DOC-000009", "expected_evidence_shape": "requirement", "page_no": 15, "coverage_unit_id": "DOC-000009_requirement_15_40", "coverage_semantic_key": "Error handling"}'
    _assert_case(json.loads(case))
...
def test_doc_000009_golden_46() -> None:
    case = '{"kind": "coverage_requirement", "query": "Protocol initialization, start and stop of communication有哪些要求？", "must_include": "Protocol initialization, start and stop of communication", "source": "coverage", "assert_mode": "rich_answer", "target_doc_id": "DOC-000009", "expected_evidence_shape": "requirement", "page_no": 15, "coverage_unit_id": "DOC-000009_requirement_15_33", "coverage_semantic_key": "Protocol initialization, start and stop of communication"}'
    _assert_case(json.loads(case))
...
def test_doc_000009_golden_47() -> None:
    case = '{"kind": "coverage_requirement", "query": "Timings有哪些要求？", "must_include": "Timings", "source": "coverage", "assert_mode": "rich_answer", "target_doc_id": "DOC-000009", "expected_evidence_shape": "requirement", "page_no": 15, "coverage_unit_id": "DOC-000009_requirement_15_26", "coverage_semantic_key": "Timings"}'
    _assert_case(json.loads(case))

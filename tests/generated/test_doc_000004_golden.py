...
def test_doc_000004_golden_28() -> None:
    case = json.loads("{\"kind\": \"publication_date\", \"query\": \"QC/T 1036—2016 的发布日期是什么？\", \"must_include\": \"2016-04-05\", \"source\": \"local\", \"assert_mode\": \"context_contains\", \"target_doc_id\": \"DOC-000004\"}")
    _assert_case(case)

@pytest.mark.integration
@pytest.mark.benchmark
def test_doc_000004_golden_29() -> None:
    case = json.loads("{\"kind\": \"publication_date\", \"query\": \"QC/T 1036—2016 是哪一天发布的？\", \"must_include\": \"2016-04-05\", \"source\": \"local\", \"assert_mode\": \"context_contains\", \"target_doc_id\": \"DOC-000004\"}")
    _assert_case(case)

@pytest.mark.integration
@pytest.mark.benchmark
def test_doc_000004_golden_30() -> None:
    case = json.loads("{\"kind\": \"effective_date\", \"query\": \"QC/T 1036—2016 的实施日期是什么？\", \"must_include\": \"2016-09-01\", \"source\": \"local\", \"assert_mode\": \"context_contains\", \"target_doc_id\": \"DOC-000004\"}")
    _assert_case(case)

@pytest.mark.integration
@pytest.mark.benchmark
def test_doc_000004_golden_31() -> None:
    case = json.loads("{\"kind\": \"effective_date\", \"query\": \"QC/T 1036—2016 从哪一天开始实施？\", \"must_include\": \"2016-09-01\", \"source\": \"local\", \"assert_mode\": \"context_contains\", \"target_doc_id\": \"DOC-000004\"}")
    _assert_case(case)

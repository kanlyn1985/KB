"""SQLite-backed audit log for service actions.

Adapted from agent_kb_core security/audit; schema is self-contained
(no dependency on agent_kb SchemaMigrator).
"""
...
CREATE INDEX IF NOT EXISTS idx_audit_principal
    ON audit_events(tenant_id, principal_id);
"""
...
class AuditLog:
    def __init__(self, connection: sqlite3.Connection) -> None:
        ...
        self.connection.executescript(AUDIT_SCHEMA_SQL)

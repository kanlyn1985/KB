...
CREATE INDEX IF NOT EXISTS idx_parse_views_doc_page ON parse_views(doc_id, page_no);
CREATE INDEX IF NOT EXISTS idx_parse_views_doc_status ON parse_views(doc_id, status);
CREATE INDEX IF NOT EXISTS idx_page_parse_selection_doc_id ON page_parse_selection(doc_id);

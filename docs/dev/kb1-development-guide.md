...
| parse_risk_profile | 将 raw high-risk 页面拆成 no_evidence、evidence_without_source_unit、source_unit_without_fact、fully_backed；Dashboard 只按 actionable_parse_risk_pages 告警。 |
